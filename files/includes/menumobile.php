...
<div class="dropdown menu-box">
    ...
    <div class="dropdown-content">
        ...
        <a href="wrought-iron-gates.php">Wrought Iron Gates</a>
        <a href="custom-hand-rails.php">Custom Hand Railings</a>
        <a href="garden-art.php">Garden Art</a>
        <a href="plate-holders.php">Plate Hangers</a>
        <a href="curtain-hardware.php">Curtain Hardware</a>
        <a href="signs-and-brackets.php">Signs and Brackets</a>
